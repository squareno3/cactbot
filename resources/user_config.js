...
let UserConfig = {
  ...
  processOptions: function(options, savedConfig, template) {
    // take options from the template, find them in savedConfig, and apply them to options.
    // this also handles setting defaults for anything in the template, even if it does not
